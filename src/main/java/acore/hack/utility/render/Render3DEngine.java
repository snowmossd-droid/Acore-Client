...
public class Render3DEngine {
   ...
   public static void setFilledBoxVertexes(@NotNull BufferBuilder bufferBuilder, Matrix4f m, @NotNull Box box, @NotNull Color c) {
      ...
      bufferBuilder.vertex(m, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, maxX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      bufferBuilder.vertex(m, minX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
   ...
   public static void setFilledSidePoints(BufferBuilder buffer, Matrix4f matrix, Box box, Color c, Direction dir) {
      ...
      if (dir == Direction.DOWN) {
         buffer.vertex(matrix, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      }

      if (dir == Direction.NORTH) {
         buffer.vertex(matrix, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, minX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      }
      ...
      if (dir == Direction.EAST) {
         buffer.vertex(matrix, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, maxY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      }
      ...
      if (dir == Direction.SOUTH) {
         ...
         buffer.vertex(matrix, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, maxX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
         buffer.vertex(matrix, minX, maxY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      }
   ...
   public static void setFilledFadePoints(Box box, BufferBuilder buffer, Matrix4f posMatrix, Color c, Color c1) {
      ...
      buffer.vertex(posMatrix, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, minX, maxY, minZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, maxX, maxY, minZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, maxX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, maxX, maxY, minZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, maxX, maxY, maxZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, maxX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, maxX, maxY, maxZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, minX, maxY, maxZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, minX, minY, minZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, minX, minY, maxZ).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha());
      buffer.vertex(posMatrix, minX, maxY, maxZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
      buffer.vertex(posMatrix, minX, maxY, minZ).color(c1.getRed(), c1.getGreen(), c1.getBlue(), c1.getAlpha());
   ...
   public static void drawTargetEsp(MatrixStack stack, @NotNull Entity target) {
      ...
      for (int j = 0; j < vecs.size() - 1; j++) {
         ...
         int col = Render2DEngine.injectAlpha(HudEditor.getColor((int)(j / 20.0F)), (int)(alpha * 255.0F)).getRGB();
         Color color = new Color(col, true);
         bufferBuilder.vertex(matrix, (float)vecs.get(j).x, (float)vecs.get(j).y, (float)vecs.get(j).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
         bufferBuilder.vertex(matrix, (float)vecs.get(j + 1).x, (float)vecs.get(j + 1).y + 0.1F, (float)vecs.get(j + 1).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
      }
      ...
      for (int j = 0; j < vecs1.size() - 1; j++) {
         ...
         int col = Render2DEngine.injectAlpha(HudEditor.getColor((int)(j / 20.0F)), (int)(alpha * 255.0F)).getRGB();
         Color color = new Color(col, true);
         bufferBuilder.vertex(matrix, (float)vecs1.get(j).x, (float)vecs1.get(j).y, (float)vecs1.get(j).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
         bufferBuilder.vertex(matrix, (float)vecs1.get(j + 1).x, (float)vecs1.get(j + 1).y + 0.1F, (float)vecs1.get(j + 1).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
      }
      ...
      for (int j = 0; j < vecs2.size() - 1; j++) {
         ...
         int col = Render2DEngine.injectAlpha(HudEditor.getColor((int)(j / 20.0F)), (int)(alpha * 255.0F)).getRGB();
         Color color = new Color(col, true);
         bufferBuilder.vertex(matrix, (float)vecs2.get(j).x, (float)vecs2.get(j).y, (float)vecs2.get(j).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
         bufferBuilder.vertex(matrix, (float)vecs2.get(j + 1).x, (float)vecs2.get(j + 1).y + 0.1F, (float)vecs2.get(j + 1).z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha());
      }
   ...
   public static void drawSphere(MatrixStack matrix, float radius, int slices, int stacks, int color) {
      ...
      for (int i = 1; i < stacks; i++) {
         ...
         for (int j = 0; j < slices; j++) {
            ...
            buffer.vertex(matrix.peek().getPositionMatrix(), x * radius, y * radius, z * radius).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
         }
   ...
   public static void drawCylinder(MatrixStack stack, float radius, float height, int slices, int stacks, int color) {
      ...
      for (int j = 0; j <= stacks; j++) {
         for (int i = 0; i <= slices; i++) {
            ...
            buffer.vertex(stack.peek().getPositionMatrix(), x * radius, y, z * radius).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
         }
         y += dz;
      }
      ...
      for (int i = 0; i <= slices; i++) {
         float x = (float)Math.cos(i * da);
         float z = (float)Math.sin(i * da);
         buffer.vertex(stack.peek().getPositionMatrix(), x * radius, 0.0F, z * radius).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
         buffer.vertex(stack.peek().getPositionMatrix(), x * radius, height, z * radius).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
      }
   ...
   public static void drawCircle3D(MatrixStack stack, Entity ent, float radius, int color, int points, boolean hudColor, int colorOffset) {
      ...
      for (int i = 0; i <= points; i++) {
         ...
         if (hudColor) {
            currentColor = HudEditor.getColor(i * colorOffset).getRGB();
         }
         Color col = new Color(currentColor, true);
         bufferBuilder.vertex(matrix, (float)(radius * Math.cos(i * 6.28 / points)), 0.0F, (float)(radius * Math.sin(i * 6.28 / points)))
   ...
   public static void drawOldTargetEsp(MatrixStack stack, Entity target) {
      ...
      double y = target.prevY
         ...
         - Module.mc.getEntityRenderDispatcher().camera.getPos().getY()
      ...
      for (int i = 0; i <= 30; i++) {
         ...
         Color col1 = new Color(Render2DEngine.injectAlpha(HudEditor.getColor(i), 170).getRGB(), true);
         Color col2 = new Color(Render2DEngine.injectAlpha(HudEditor.getColor(i), 0).getRGB(), true);
         bufferBuilder.vertex(stack.peek().getPositionMatrix(), cos, (float)nextY, sin)
            .color(col1.getRed(), col1.getGreen(), col1.getBlue(), col1.getAlpha());
         bufferBuilder.vertex(stack.peek().getPositionMatrix(), cos, (float)y, sin)
            .color(col2.getRed(), col2.getGreen(), col2.getBlue(), col2.getAlpha());
      }
   ...
   public static void renderGhosts(LivingEntity target, float anim, float red, float speed) {
      if (target != null && Module.mc.player != null) {
         ...
         double iAge = Render2DEngine.interpolate(Module.mc.player.prevAge - 1, Module.mc.player.age, getTickDelta());
         ...
         for (int j = 0; j < 4; j++) {
            for (int i = 0; i <= length; i++) {
               ...
               if (!(scale <= 0.0F)) {
                  ...
                  int colorVal = applyRedAndAlpha(baseColor, 1.0F + red * 10.0F, offset * anim);
                  Color col = new Color(colorVal, true);
                  float halfScale = scale / 2.0F;
                  Matrix4f matrix = matrices.peek().getPositionMatrix();
                  buffer.vertex(matrix, -halfScale, halfScale, 0.0F).texture(0.0F, 1.0F).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
                  buffer.vertex(matrix, halfScale, halfScale, 0.0F).texture(1.0F, 1.0F).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
                  buffer.vertex(matrix, halfScale, -halfScale, 0.0F).texture(1.0F, 0.0F).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
                  buffer.vertex(matrix, -halfScale, -halfScale, 0.0F).texture(0.0F, 0.0F).color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
               }
            }
         }
   ...
   public static Vec3d interpolatePos(float prevposX, float prevposY, float prevposZ, float posX, float posY, float posZ) {
      double x = prevposX + (posX - prevposX) * getTickDelta() - Module.mc.getEntityRenderDispatcher().camera.getPos().getX();
      double y = prevposY + (posY - prevposY) * getTickDelta() - Module.mc.getEntityRenderDispatcher().camera.getPos().getY();
      double z = prevposZ + (posZ - prevposZ) * getTickDelta() - Module.mc.getEntityRenderDispatcher().camera.getPos().getZ();
